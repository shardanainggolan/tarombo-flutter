...
class _$SearchResultImpl extends _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(id: $id, firstName: $firstName, lastName: $lastName, gender: $gender, marga: $marga, birthDate: $birthDate, photoUrl: $photoUrl)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, firstName, lastName, gender, marga, birthDate, photoUrl);
...
abstract class _SearchResult extends SearchResult {
  const factory _SearchResult(
      ...
      final String? marga,
      final DateTime? birthDate,
      final String? photoUrl}) = _$SearchResultImpl;
